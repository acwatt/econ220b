...
EV.nk = function(EVold, Tprime, c, RC, P, beta,
...
c = c2(x, theta1)
P = P.fun(theta3)
EV_out = EV.sequential(theta1, theta3, c, RC, P, beta, verbose=F)
pk = pk.fun(c, beta, EV, RC)
Tprime = Tprime.fun(beta, P, pk)
EVnew = EV.nk(EV_out$EVnew, Tprime, c, RC, P, beta)
